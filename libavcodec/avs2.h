...
#ifndef AVCODEC_CAVS2_H
#define AVCODEC_CAVS2_H
...
typedef struct AVS2Block {

} AVS2Block;

/* coding unit */
typedef struct AVS2CU {

} AVS2CU;

/* coding unit tree */
typedef struct AVS2CUTree {
