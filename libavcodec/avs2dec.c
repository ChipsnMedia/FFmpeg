...
#define HWACCEL_MAX (CONFIG_AVS2_VAAPI_HWACCEL)
    ...
    if (seq->output_bit_depth == AVS2_BIT_DEPTH_10) {
...
static int ff_avs2_decode_frame(AVCodecContext *avctx, void *out_frame, 
...
const AVCodec ff_avs2_decoder = {
    .name           = "avs2",
    .long_name      = NULL_IF_CONFIG_SMALL("AVS2-Video; Chinese GY/T 299.1-2016 or"
                                           " GB/T 33475.2-2016; IEEE 1857.4-2018"),
    .type           = AVMEDIA_TYPE_VIDEO,
    .id             = AV_CODEC_ID_AVS2,
    .priv_data_size = sizeof(AVS2Context),
    .priv_class     = &avs2_class,
    .init           = ff_avs2_decode_init,
    .close          = ff_avs2_decode_end,
    .decode         = ff_avs2_decode_frame,
